// Minimal Express server for Vercel deployment
    ...
    <body>
      <div class="container">
        ...
        <div class="card">
          ...
          <a href="/app/pages?shop=${shop}" class="btn">
  ...
  res.send(`
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>Pages</h1>
          <a href="/app/builder?pageId=new&shop=${shop}" class="btn">
        ...
        <div class="pages-list">
          <div class="page-item">
            ...
            <div class="page-actions">
              <a href="/app/builder?pageId=1&shop=${shop}" class="action-btn">
          ...
          <div class="page-item">
            ...
            <div class="page-actions">
              <a href="/app/builder?pageId=2&shop=${shop}" class="action-btn">
                <i class="fas fa-edit"></i> Edit
              </a>
              <button class="action-btn">
                <i class="fas fa-eye"></i> View
          ...
          <div class="page-item">
            ...
            <div class="page-actions">
              <a href="/app/builder?pageId=3&shop=${shop}" class="action-btn">
                <i class="fas fa-edit"></i> Edit
              </a>
              <button class="action-btn">
                <i class="fas fa-eye"></i> View

          ...
          <script>
            ...
            function updatePropertiesPanel(element) {
              ...
              switch (elementType) {
                  ...
                  propertiesHTML = `
                    <div class="property-group">
                      ...
                      <div class="property-row">
                        ...
                        <input type="text" id="image-url" placeholder="https://example.com/image.jpg" onchange="updateElementProperty('src', this.value)">
                      </div>
                      <div class="property-row">
                        <label for="image-alt">Alt Text</label>
                        <input type="text" id="image-alt" placeholder="Descriptive text for image" onchange="updateElementProperty('alt', this.value)">
                      </div>
                      <div class="property-row">
                        <label for="image-link">Link (optional)</label>
                        <input type="text" id="image-link" placeholder="https://example.com" onchange="updateElementProperty('link', this.value)">
                      </div>
                    </div>
                    <div class="property-group">
                      <h3>Actions</h3>
                      <button onclick="uploadImage()" style="background: #3b82f6; color: white; border: none; padding: 8px 16px; border-radius: 4px; cursor: pointer; width: 100%; margin-bottom: 10px;">Upload Image</button>
                      <button onclick="deleteElement()" style="background: #ef4444; color: white; border: none; padding: 8px 16px; border-radius: 4px; cursor: pointer; width: 100%;">Delete Element</button>
                    </div>
                  `;
                  break;
                ...
                case 'button':
                  const buttonText = element.querySelector('button').textContent;
                  propertiesHTML = `
                    <div class="property-group">
                      <h3>Button Properties</h3>
                      <div class="property-row">
                        <label for="button-text">Button Text</label>
                        <input type="text" id="button-text" value="${buttonText}" onchange="updateElementProperty('text', this.value)">
                      </div>
                      <div class="property-row">
                        <label for="button-link">Button Link</label>
                        <input type="text" id="button-link" placeholder="https://example.com" onchange="updateElementProperty('link', this.value)">
                      </div>
                      <div class="property-row">
                        <label for="button-color">Button Color</label>
                        <select id="button-color" onchange="updateElementProperty('color', this.value)">
                      ...
                      <div class="property-row">
                        ...
                        <select id="button-size" onchange="updateElementProperty('size', this.value)">
            ...
            function updateElementProperty(property, value) {
              ...
              switch (elementType) {
                ...
                case 'image':
                  if (property === 'src') {
                    const placeholder = selectedElement.querySelector('.placeholder');
                    if (placeholder) {
                      placeholder.remove();
                    ...
                    const img = selectedElement.querySelector('img');
                    if (img) {
                      // If there's already a link, update it, otherwise create a new one
                      ...
                      if (!link && value) {
                        ...
                        // Remove the link if the value is empty
                ...
                case 'button':
                  if (property === 'text') {
                    ...
                    button.setAttribute('data-link', value);
                  } else if (property === 'color') {
                    const button = selectedElement.querySelector('button');
                    
                    // Remove any existing color classes
                    button.classList.remove('primary', 'secondary', 'success', 'danger');
                    
                    // Add the new color class
                    button.classList.add(value);
                    
                    // Update button styles based on the color
                    switch (value) {
                      case 'primary':
            ...
            function addDefaultContent() {
              ...
              // Add sample content
              const content = `
                <div id="element-heading-1" class="widget-element heading-widget">
